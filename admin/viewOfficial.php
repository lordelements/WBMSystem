			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<div class="slider--content">
						...
						$result = mysqli_query ($cn, "SELECT * FROM officials WHERE officialid = '$offid'");
						$row = mysqli_fetch_assoc($result);

						echo '
						<form class="mb-0" method="post" action="updOfficials.php" enctype="multipart/form-data" style="margin-top: -100px;">
									...
									<div class="col-xs-12 col-sm-6 col-md-12">
										<div class="form-group">
											<div class="select--box">
												<input type="text" name="position" class="form-control" id="select-position" value="'.$row['position'].'" style="color:black;" required>
											</div>
										</div>
									</div>
